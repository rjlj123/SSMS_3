Public Class Manager_Backroom_Bins
    ...
    Private Sub Manage_Backroom_Bins_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.Product_BinTableAdapter.Fill(Me.SSMS_DATABASEDataSet.Product_Bin)
        Me.BinTableAdapter.Fill(Me.SSMS_DATABASEDataSet.Bin)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Add_Bin.Click
        ...
        BinTableAdapter.Update(SSMS_DATABASEDataSet)                                        'adds a bin to the database
