Public Class Manage_Backroom
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        LastForm = Me
        Me.Hide()
        Manage_Backroom_Departments.Show() 'shows the Manage Backroom Departments form
    End Sub

    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        LastForm = Me
        Me.Hide()
        Manage_Backroom_Bins.Show() 'shows the Manage Backroom Bins form
    End Sub
End Class